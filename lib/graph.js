...
Graph.prototype.get = function async() {
  var self = this;
...
Graph.prototype.post = function async() {
...
exports.get = function async(url, params) {
  if (params)  {
    url += ~url.indexOf('?') ? '&' : '?';
    url += qs.stringify(params);
  }

  return new Graph('GET', url);
};
...
exports.authorize = function async(params, callback) {
  var self = this;
